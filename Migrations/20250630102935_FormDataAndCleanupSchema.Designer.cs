...
namespace CTOM.Migrations
{
    ...
    [Migration("20250630102935_FormDataAndCleanupSchema")]
    partial class FormDataAndCleanupSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CTOM.Models.Entities.ReportDataTransaction", b =>
                {
                    ...
                    b.ToTable("ReportDataTransactions");
                });

            modelBuilder.Entity("CTOM.Models.Entities.ReportDataTransactionField", b =>
                {
                    b.Property<int>("TransactionFieldID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TransactionFieldID"));
                    ...
                    b.ToTable("ReportDataTransactionFields");
                });
            ...
            modelBuilder.Entity("CTOM.Models.Entities.ReportDataTransaction", b =>
                {
                    b.HasOne("CTOM.Models.Entities.ApplicationUser", "Approver")
                        .WithMany()
                        .HasForeignKey("ApprovedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CTOM.Models.Entities.ApplicationUser", "Creator")
                        .WithMany()
                    ...
                    b.HasOne("CTOM.Models.Entities.Templates", "Template")
                        .WithMany("ReportDataTransactions")
                        .HasForeignKey("TemplateID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CTOM.Models.Entities.ApplicationUser", "Updater")
                        .WithMany()
            ...
            modelBuilder.Entity("CTOM.Models.Entities.ReportDataTransactionField", b =>
                {
                    ...
                    b.HasOne("CTOM.Models.Entities.ReportDataTransaction", "Transaction")
                        .WithMany("ReportDataTransactionFields")
            ...
            modelBuilder.Entity("CTOM.Models.Entities.ReportDataTransaction", b =>
                {
                    b.Navigation("ReportDataTransactionFields");
                });

            modelBuilder.Entity("CTOM.Models.Entities.Templates", b =>
                {
                    b.Navigation("ReportDataTransactions");
